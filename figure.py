...
line class를 이용하여 선의 길이를 설정/참조를 수행합니다.
...
class line:
    ...
    해당 변수를 수정하고 접근하기 위해
    set length와, get_length와 메소드를 제공합니다.
    """
    __width=0
    __height=0
    ...
    def set_length(self, width, height):
        ...
        선의 길이를 수정합니다.
        Args:
            width(int or float): 수정하고자 하는 가로 길이 입니다.
            height(int or length): 수정하고자 하는 세로 길이 입니다.
        """
        self.__width = width
        self.__height = height
